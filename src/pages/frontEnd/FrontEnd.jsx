    ...
    <div style={{ paddingTop: '112px' }}>
      ...
      <section>
        <div className='pt-5 pb-3 container text-lg'>
          ...
          <a className='text-blue-500' href="https://hocwebchuan.com/reference/tag/">Tham khảo những thẻ HTML ở đây <i className="fa fa-arrow-right"></i></a>
          <ol className='mb-0'>
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/tag_div.php">Thẻ div</a></h4>
            ...
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/html5/tag_header.php">Header</a></h4>
              <p>Thẻ header dùng để chứa những nội dung được hiển thị trong phần đầu của trang web</p>
            </li>
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/html5/tag_footer.php">Footer</a></h4>
            ...
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/tag_hx.php"> Các thẻ tiêu đề h1, h2, h3, h4, h5, h6</a></h4>
            ...
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/tag_img.php">Thẻ img</a></h4>
            ...
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/tag_a.php">Thẻ a</a></h4>
            ...
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/tag_input.php">Thẻ input</a></h4>
              <p>Thẻ input dùng để tạo một trường nhập dữ liệu.</p>
            </li>
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/tag_button.php">Thẻ button</a></h4>
              <p>Thẻ button để tạo một nút nhấn thực hiện một thao tác nào đó.</p>
            </li>
            <li>
              <h4><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/tag_p.php">Thẻ p</a>
              </h4>
              <p>Thẻ p dùng để chèn một đoạn văn bản</p>
            </li>
            <h6><a className='text-blue-500 font-bold' href="https://hocwebchuan.com/reference/tag/">Và còn nhiều thẻ khác cần tìm hiểu và vận dụng</a></h6>
          </ol>
        </div>
      </section>
      ...
      <section className='pt-5 pb-3' style={{ backgroundColor: '#9e9e9e' }}>
        ...
        <a href="https://getbootstrap.com/docs/5.2/getting-started/introduction/">Tìm hiểu về Bootstrap <i className="fa fa-arrow-right"></i></a>
        </div>
      ...
      <section className='pt-5 pb-3' style={{ backgroundColor: '#cfcfcf' }}>
        <div className='container text-lg'>
          ...
          <a className='block text-blue-400' href="https://quantrimang.com/javascript-la-gi-155978">Tìm hiểu về JS</a>
