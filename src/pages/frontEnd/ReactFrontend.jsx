        ...
        <div className='text-teal-200' style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
          ...
          <section className='container' id='thietkethumucreact'>
            ...
            <div className="pl-4">
              ...
              <NavLink className='text-teal-500 font-bold text-lg' to='/'>Cách setup từng folder và từng file</NavLink>
            </div>
          </section>
          ...
          <section className='container' id='deployreactapp'>
            ...
            <div className="pl-4">
              ...
              <a href="https://github.com/gitname/react-gh-pages">Xem hướng dẫn của github tại đây</a>
              <p>Để deploy react-app lên Github page chắc chắn bạn phải cần kiến thức về git. <NavLink className='text-black' to='/'>Ấn vào đây</NavLink></p>
