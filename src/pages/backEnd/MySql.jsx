            ...
            <div className='grid grid-cols-6'>
                <div className="w-4/5 m-auto text-xs md:text-base col-span-5">
                    ...
                    <section id='define__mysql'>
                        ...
                        <p>Sau đó tạo các database và các bảng, và làm việc với các bảng đó. </p>
                    </section>

                    <section id='thao_tac'>
                        <h2 className='text-xl font-bold mt-3'>Các thao tác căn bản với database và bảng:</h2>
                ...
                <div className='bg-teal-400 p-3'>
                    <div className="w-4/5 m-auto fixed">
                        ...
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#define__mysql'> MySQL là gì?</a></h2>
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#thao_tac'>Thao tác căn bản với MySQL</a></h2>
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#CRUD'>CRUD trong MySQL</a></h2>
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#mysql_command'>Lệnh thường dùng MySQL</a></h2>
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#relation'>Quan hệ và cách truy suất</a></h2>
                    </div>
                </div>
            </div>
        </div>
