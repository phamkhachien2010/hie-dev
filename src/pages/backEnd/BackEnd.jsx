  ...
  return (
    <div style={{ paddingTop: '112px' }}>
      <div className='container text-lg w-2/3 m-auto'>
        ...
        <section>
          <h2 className='text-2xl pl-5 mb-0 mt-2'>Back-end developer làm những gì?</h2>
        ...
        <section>
          <h2 className='text-2xl pl-5 mb-0 mt-2'>Những công nghệ phục vụ thiết kế back-end</h2>
        ...
        <section>
          <h2 className='text-2xl pl-5 mb-0 mt-2'>NodeJs</h2>
        ...
        <section>
          <h2 className='text-2xl pl-5 mb-0 mt-2'>Thư viện, framework hỗ trợ mạnh NodeJS là express và sequelize</h2>
