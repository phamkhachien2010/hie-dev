    ...
    <div className={styleFrontend.tech}>
      ...
      <div className='grid grid-cols-6'>
        <section className='col-span-5'>
          <h1 className='text-2xl lg:text-4xl text-center py-3 font-bold'>Tìm hiểu về React</h1>
          <div className='w-2/3 m-auto'>
            <section id='reactLaGi' className='text-xs md:text-base' >
              <h2 className='text-xl md:text-2xl font-bold pt-3'>React là gì</h2>
              <div className='pl-4'>
                ...
                <h4 className='text-xl font-bold'>Lifecycle</h4>
            ...
            <section id='ungdungreact' className='text-xs md:text-base'>
              <h2 className='text-xl md:text-2xl font-bold'>Ứng dụng react như thế nào</h2>
              <div className="pl-4">
                ...
                <p>Sau đó, có thể dùng những <NavLink to='/other/library' className='text-blue-500 font-bold text-lg'> thư viện</NavLink> hỗ trợ để link qua lại giữa các page với nhau. Về bản chất là tạo ra các giao diện của 1 website thì react hỗ trợ tương đối tốt.</p>
              </div>
            </section>

            <section className='text-xs md:text-base' id='thietkethumucreact'>
              <h2 className='text-xl md:text-2xl font-bold'>Thiết kế thư mục react như thế nào.</h2>
              <div className="pl-4">
                ...
                <NavLink className='text-blue-500 font-bold text-lg' to='/other/cau-hinh-folder-react'>Cách setup từng folder và từng file.</NavLink>
              </div>
            </section>

            <section className='text-xs md:text-base' id='deployreactapp'>
              <h2 className='text-xl md:text-2xl font-bold'>Deploy react app.</h2>
              <div className="pl-4">
                ...
                <a className='text-blue-500' href="https://blog.logrocket.com/8-ways-deploy-react-app-free/" target='_blank'>Xem hướng dẫn tại đây</a>
                <p>Web này mình deploy với vercel. Lên trang chủ của <a className='text-blue-500' href="https://vercel.com/" target='_blank'>Vercel</a> kết nối với github và làm theo hướng dẫn là được. Phải đợi một chút thời gian để vercel deploy app</p>
            ...
            <section className='text-xs md:text-base' id='loithuonggap'>
              <h2 className='text-xl md:text-2xl font-bold'>Các lỗi thường gặp của react.</h2>
              <div className="pl-4">
            ...
            <section className='text-xs md:text-base' id='problem'>
              <h2 className='text-xl md:text-2xl font-bold'>Một số vấn đề khác của ReactJs.</h2>
              <div className="pl-4">
                <h3 className='text-xl font-bold pl-3'>Pure component</h3>
                ...
                <h3 className='text-xl font-bold pl-3'>Redux</h3>
                ...
                <h3 className='text-xl font-bold pl-3'>Lifecycle react</h3>
                ...
                <p className='text-zinc-400 font-bold'>Mounting có 3 thành phần chính là CompponentWillMonut, render và ComponentDidMount.</p>
                ...
                <p className='text-zinc-400 font-bold'>Updating có những thành phần như sau:</p>
                ...
                <p className='text-zinc-400 font-bold'>Unmounting:</p>
                ...
                <h3 className='text-xl font-bold pl-3 mt-3'>Hooks</h3>
                ...
                <p className='text-zinc-400 font-bold'>Các hooks thường được sử dụng:</p>
                ...
                <h3 className='text-xl font-bold pl-3 mt-3'>React-router-dom</h3>
        ...
        <div className='bg-teal-400 p-3'>
          <div className="w-4/5 m-auto fixed">
            ...
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#reactLaGi'> React là gì?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#ungdungreact'>Ứng dụng react như thế nào?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#thietkethumucreact'>Thiết kế thư mục react app</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#deployreactapp'>Deploy react app như thế nào?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#loithuonggap'>Các lỗi thường gặp khi dùng react</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#problem'>Một số vấn đề khác</a></h2>
          </div>
        </div>
      </div>
    </div>
