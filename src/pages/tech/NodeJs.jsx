        ...
        <div className={styleBackEnd.tech}>
            ...
            <div className='grid grid-cols-6'>
                <div className="w-2/3 m-auto text-xs lg:text-base col-span-5">
                    <h1 className='text-center text-2xl lg:text-4xl font-bold pt-5 pb-3'>Tìm hiểu về NodeJs</h1>
                    <div id='nodeJsBase'>
                    ...
                    <section id='enviroment'>
                        <h2 className='text-sm lg:text-xl font-bold pl-3 m-0 pt-3'>Cần chú ý 3 môi trường làm việc</h2>
                        ...
                        <h2 className='text-sm lg:text-xl m-0 pl-3 pt-3'>Khác nhau giữa SSR và CSR</h2>
                    ...
                    <section id='fetch_api'>
                        <h2 className='text-sm lg:text-xl m-0 pl-3 pt-3 font-bold'>Nguyên tắc thiết kế API</h2>
                ...
                <div className='bg-teal-400 p-3'>
                    <div className="w-4/5 m-auto fixed">
                        ...
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#nodeJsBase'> NodeJs là gì?</a></h2>
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#enviroment'>Môi trường làm việc của code</a></h2>
                        <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#fetch_api'>Nguyên tắc thiết kế API</a></h2>
                    </div>
                </div>
            </div>
        </div >
