  ...
  return (
    <div className={styleBackEnd.frontEnd__content}>
      <div className="grid grid-cols-6">
        <div className='w-4/5  m-auto text-md md:text-lg col-span-5'>
          <h1 className='text-2xl md:text-4xl font-bold text-center pt-5'>Back-end</h1>

          <section id='define-back-end'>
        ...
        <div className='bg-teal-400 p-3'>
          <div className="w-4/5 m-auto fixed">
            ...
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#define-back-end'> Back-end là gì?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#dev_back_end'>Dev back-end làm gì?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#tech_back_end'>Những công nghệ giúp thiết kế back-end</a></h2>
          </div>
        </div>
      </div>
    </div>
