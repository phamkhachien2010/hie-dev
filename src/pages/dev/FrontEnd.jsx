    ...
    <div className={styleFrontEnd.frontEnd__content} >
      <div className='grid grid-cols-6'>
        <div className='col-span-5'>
          ...
          <section id='define_css' className='pt-5 pb-3' style={{ backgroundColor: '#9e9e9e' }}>
          ...
          <section id='define_js' className='pt-5 pb-3' style={{ backgroundColor: '#cfcfcf' }}>
            <div className='text-sm w-4/5 m-auto md:text-lg'>
          ...
          <section id='dev_front_end' className='pt-5 pb-3'>
            <div className='text-sm w-4/5 m-auto md:text-lg'>
        ...
        <div className='bg-teal-400 p-3'>
          <div className="w-4/5 m-auto fixed">
            ...
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#define-front-end'> Front-end là gì?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#define_html'>Html là gì?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#define_css'>CSS là gì?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#define_js'>Js là gì?</a></h2>
            <h2 className='text-sx sm:text-sm lg:text-base'><a className='text-black' href='#dev_front_end'>Dev front-end làm gì</a></h2>
          </div>
        </div>
      </div>
    </div>
